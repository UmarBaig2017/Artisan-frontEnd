...
export default class MiCategory extends Component {
  ...
  DeleteCategory(e) {
    ...
    console.log(e)
    fetch("https://powerful-oasis-74577.herokuapp.com/api/deleteCategory",
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json"
  ...
  async AddCategory() {
    let category = {
      ...
      await fetch("https://powerful-oasis-74577.herokuapp.com/api/addCategory",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
  ...
  async fetchIconDataType() {
    ...
    const response = await fetch("https://powerful-oasis-74577.herokuapp.com/api/getIcons" + iconname);
