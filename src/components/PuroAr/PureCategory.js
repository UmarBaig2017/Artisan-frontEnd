...
export default class PureArCategory extends Component {
  ...
  DeleteSubCat(cat, subcat, id) {
    console.log(cat, subcat, id)
    let arr = this.state.Categories
    let deletecat = arr[cat].subCategories.splice(subcat, 1)
    console.log(deletecat)
    console.log(arr)
    let data = {
      id: id,
      subCategories: arr[cat].subCategories
    }
  ...
  DeleteCategory(e) {
    ...
    console.log(e)
    fetch("https://polar-wildwood-42259.herokuapp.com/api/deleteCategory",
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json"
  ...
  async AddCategory() {
    ...
    await fetch("https://polar-wildwood-42259.herokuapp.com/api/addCategory",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
  ...
  async fetchIconDataType() {
    ...
    const response = await fetch("https://polar-wildwood-42259.herokuapp.com/api/getIcons" + iconname);
    ...
    return (
      <div>
        ...
        <div className="container-fluid row">
          ...
          <div style={{ "overflow": "scroll", "height": 700 }} className="col-md-3 ">
            <ul className="navbar-nav">
              <br />
              ...
              <li  style={{"marginBottom": 10}} className="nav-item">
                <li  className="list-group-item bg-light"> <h3><i className="fa fa-tachometer"></i>    <b> Las categorías </b></h3> </li>
              </li>
              <li style={{"marginBottom": 10}}  className="nav-item">
              <button className="btn btn-success btn-lg"><li onClick={() => {
                this.setState({ addCat: true, adSubCat: false })
              }} > <div className="col-md-1"></div> <i className="fa fa-plus" aria-hidden="true"></i> Añadir categoría</li></button>
            </li>
              {this.state.loading &&
              ...
              {this.state.loading === false && this.state.Categories.length > 0 && this.state.Categories.map((categori, index) => {
                return (
                  <li style={{ "padding": "20", }}  className="nav-item">
                    ...
                    <div className="list-group-item bg-light "> <h4 style={{ "marginTop": 10, "fontFamily": "Comic Sans MS" }}> {categori.name}   <a href={"#nw" + index} data-toggle="collapse"> <i   className="fas fa-sort-down"></i></a>  <a href=""> <i style={{ "float": "right" }} onClick={() => { this.DeleteCategory(categori._id) }} className="fas fa-trash"> </i> </a> </h4> </div>
                    ...
                    {categori.subCategories.map((subCatigori, i) => {
                      return (
                        <li style={{"marginBottom": 5,  }} className="nav-item">
                          <li className=" bg-light"> <div className="col-md-1"></div> <i className="fa fa-list" aria-hidden="true"></i> {subCatigori.name}  <i onClick={() => { this.DeleteSubCat(index, i, categori._id) }} className="fas fa-trash"></i> </li>

                        </li>
                      )
                    })}
                    <li>  <button><li onClick={() => { this.setState({ adSubCat: true, addCat: false, categoryId: categori._id, categoryName: categori.name }) }} className=" bg-light"> <div className="col-md-1"></div> <i className="fa fa-plus" aria-hidden="true"></i> Añadir subcategoría</li></button> </li>
                    </div>
            ...
            <div style={{ "backgroundColor": "white", "padding": 15 }} className="form">
              ...
              <form>
                ...
                <div className="text-right">
                  <button type="button" onClick={this.handleSubmitCat.bind(this)} className="btn btn-success">
          ...
          {this.state.adSubCat && <div className="col-md-6">
            <div style={{ "backgroundColor": "white", "padding": 15 }} className="form">
              ...
              <div className="page-header text-center">
                ...
                <h2>Añadir subcategoría a {this.state.categoryName}</h2></div>
              <form>
                <label>Nombre</label>
                <input type="text" name="Name" value={this.state.Name} onChange={this.onChangeValues} className="form-control" />
                <br />
                ...
                />}
                <div className="text-right">
                  <button type="button" onClick={this.handleSubCategory.bind(this)} className="btn btn-success">Añadir subcategoría</button>
                </div>
              </form>
            </div>
