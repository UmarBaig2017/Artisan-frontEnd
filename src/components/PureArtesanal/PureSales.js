        ...
        <div class="container-fluid row">
          ...
          <div class="col-md-9">
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header"> <b>Sales Details </b></div>
                  <div class="card-body">
                            ...
                            {this.state.loading===false && this.state.Sales && this.state.Sales.map((item, index) => {
                              return (
                                <tr key={index}>
                                  ...
                                  <td>
                                    <button class="btn btn-success" onClick={() => { this.handleDeleteSales(item._id) }} type="submit" style={{ "margin": 10 }}>Delete</button>
                                    <button class="btn btn-success" type="submit" onClick={() => { this.handleModel(index) }} data-toggle="modal" data-target="#myModal">View</button>
                                  </td>
                                </tr>
                              )
                            })}
